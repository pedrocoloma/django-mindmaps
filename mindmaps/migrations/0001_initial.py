# Generated by Django 2.1.1 on 2018-12-16 20:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', mindmaps.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Listing',
        ...
        migrations.AddField(
            model_name='listing',
            name='maps',
            field=models.ManyToManyField(blank=True, related_name='maps', to='mindmaps.Map'),
        ),
    ]
